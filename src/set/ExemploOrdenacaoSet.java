...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet<>() {{
            add(new Serie("Dix Pour Cent", "Comédia", 30));
            add(new Serie("Dark", "Drama", 60));
            add(new Serie("Sex Education", "Comédia", 50));
            add(new Serie("Marvelous Mrs. Maisel", "Comédia", 60));
            add(new Serie("Alice In Borderland", "Suspense", 50));
        }};
